...
function renderLiv009DrumStageInputs(surface, adapter) {
  ...
  function renderLiv016FullBandPngBoard(surface, adapter) {
    ...
    source("guitar-1-left", 244, 245, 72);
    source("guitar-1-right", 461, 233, 72);
    ...
    source("guitar-2-left", 361, 777, 80);
    source("guitar-2-right", 685, 771, 82);
