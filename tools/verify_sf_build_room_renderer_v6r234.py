...
for ref in ['sf-build-room-renderer.css?v=6r234','sf-build-room-renderer.js?v=6r234']:
...
if 'installed v6r234' not in js: fail.append('Renderer install log is not v6r234')
if 'buildRoomSidebarRoot' not in js or 'Connection Checklist' not in js: fail.append('Renderer lacks v6r234 sidebar checklist logic')
...
if fail:
    print('[FAIL] Build-a-Room v6r234 verification failed:')
    for f in fail: print(' -', f)
    sys.exit(1)
print('[PASS] Build-a-Room v6r234 single-owner install is clean.')
