...
for ref in ['sf-build-room-renderer.css?v=6r230','sf-build-room-renderer.js?v=6r230']:
...
if 'installed v6r230' not in js: fail.append('Renderer install log is not v6r230')
if fail:
    print('[FAIL] Build-a-Room v6r230 verification failed:')
    for f in fail: print(' -', f)
    sys.exit(1)
print('[PASS] Build-a-Room v6r230 single-owner install is clean.')
