...
"LIV-025": {
    ...
    "LIV-029": {
      ...
      destLabels: {
        ...
        "press-recorder-feed-input": "Press / Recorder Feed L Input",
      ...
      requiredRoutes: [
        ...
        ["console-bus-1-output", "press-recorder-feed-input"],
...
redrawCables(layer);
  ...
  function renderLiv029DebatePanelScaffold(surface, adapter) {
    ...
    liv029GearBakedSizeStyle.textContent = [
      ...
      '.sf-live-native-level-liv-029 [data-sf-gear-id="liv029-event-console"]{height:280px!important;}',
      ...
      '.sf-live-native-level-liv-029 [data-sf-gear-id] > img{width:100%!important;height:100%!important;object-fit:contain!important;}'
    ].join("\n");
    ...
    console.log("[Signal Flow] LIV-029 debate panel gear scaffold mounted v6r647liv029gearbaked", {
