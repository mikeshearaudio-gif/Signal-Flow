...
(function () {
  ...
  function playGoodConnect() {
    // Clear, short ascending confirmation.
    playNativeTone(523.25, 0.00, 0.10, 0.14, "triangle");
    playNativeTone(783.99, 0.08, 0.13, 0.12, "triangle");
  }

  function playBadConnect() {
    // More obvious downward error chirp.
    playNativeTone(180, 0.00, 0.11, 0.16, "sawtooth");
    playNativeTone(92, 0.08, 0.16, 0.13, "sawtooth");
  }
